...
(define tests
  (test-suite
   ...
   (check-equal? (racketlist->mupllist (list (var "hi") (var "hello"))) (apair (var "hi") (apair (var "hello") (aunit))) "racketlist->mupllist test")
   (check-equal? (racketlist->mupllist (list (var "hi") (list (var "hello") (int 1)))) (apair (var "hi") (apair (apair (var "hello")  (apair (int 1) (aunit))) (aunit))) "racketlist->mupllist test")
